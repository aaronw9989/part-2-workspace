...
class LockManager {
  ...
  /**
   * Clarification of terms, and an analogy: Think of the lock on your front door - here, that's
   * like a Lock object.
   * <p>
   * The lock on your front door is an object that can be locked, or unlocked. Here, the Lock object
   * can be in one of two states: locked, or unlocked.
   * <p>
   * Calling tryLock() locks it   [if it can]. Calling unlock()  unlocks it [which should only be
   * called if it's already locked, otherwise an IllegalMonitorStateException is thrown].
   * <p>
